								...
								<div className="flex-1 overflow-auto px-4 py-4">
									<div className="flex flex-col items-center justify-center w-full">
										...
										<div className="grid grid-cols-2 gap-4 mb-8 max-w-2xl w-full">
											{/* Write copy card */}
											<div className="bg-yellow-50 dark:bg-yellow-950/20 rounded-lg p-4 border border-yellow-200 dark:border-yellow-800 flex items-center justify-between">
											...
											<div className="bg-blue-50 dark:bg-blue-950/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800 flex items-center justify-between">
												<div className="flex items-center gap-3">
											...
											{/* Create avatar card */}
											<div className="bg-green-50 dark:bg-green-950/20 rounded-lg p-4 border border-green-200 dark:border-green-800 flex items-center justify-between">
												<div className="flex items-center gap-3">
											...
											{/* Write code card */}
											<div className="bg-pink-50 dark:bg-pink-950/20 rounded-lg p-4 border border-pink-200 dark:border-pink-800 flex items-center justify-between">
												<div className="flex items-center gap-3">
